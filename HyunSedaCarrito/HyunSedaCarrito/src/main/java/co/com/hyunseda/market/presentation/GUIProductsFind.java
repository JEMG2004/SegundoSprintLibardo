...
public class GUIProductsFind extends javax.swing.JDialog implements Observer {
     ...
     */
    public GUIProductsFind(java.awt.Frame parent, boolean modal, CategoryService categoryService,ProductService productService,ShoppingCartService shoppingCartService) {
        super(parent, modal);
        initComponents();
        initializeTable();
