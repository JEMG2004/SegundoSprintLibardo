...
public class GUIAGREGARPRODUCT extends javax.swing.JFrame implements Observer{
    ...
    private void initComponents() {
        ...
        txtPalClaveAgregarProduct = new javax.swing.JTextField();
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAgregarCategoriaProducto(evt);
            }
        });
        ...
        jLabel9.setText("Palabra Clave:");
        jPanel2.add(jLabel9);
        jPanel2.add(txtPalClaveAgregarProduct);
    ...
    private void BtnAgregarCategoriaProducto(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarCategoriaProducto
        ...
        GUIADDCATEGORIAPRODUCTO abrir = new GUIADDCATEGORIAPRODUCTO(id,categoryService,productService,shoppingCartService);
        abrir.setVisible(true);
        this.setVisible(false); 
    }//GEN-LAST:event_BtnAgregarCategoriaProducto
    ...
    private javax.swing.JTextField txtPalClaveAgregarProduct;
    ...
    // End of variables declaration//GEN-END:variables
        ...
        txtPalClaveAgregarProduct.setText("");
    ...
    private void addProduct() {
       ...
       // productService.saveProduct(id,name,description)
        ...
        String keywords = txtPalClaveAgregarProduct.getText().trim();
        ...
        if (productService.findProductById(id)!=null) {
            ...
            //cleanControls();
        }else if (productService.saveProduct(id,name, description,price,stock,keywords,characteristics,categoryId)) {
